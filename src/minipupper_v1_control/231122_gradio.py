...
class Commander(Node):
    ...
    def count_walk(self, i):
        global walk
        global walk_command
        walk_command = i

        print('walk_command:', walk_command)
        print('i:', i)
        ...
        # msg.linear.y = walk[1]
        # msg.linear.z = walk[2]
        # msg.angular.x = walk[3]
        # msg.angular.y = walk[4]
        # msg.angular.z = walk[5]
    ...
    def mini_gradio(self):
        ...
        with gr.Blocks() as demo:
            ...
            **mini_pupper_getup!!**    
            ...
            with gr.Tab("control"):
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        btn_linear_x = gr.Button(
                            value="x+", label="x+")
                        btn_linear_y = gr.Button(
                            value="y+", label="y+")
                        btn_linear_z = gr.Button(
                            value="z+", label="z+")
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        btn_angular_x = gr.Button(
                            value="x+", label="x+")
                        btn_angular_y = gr.Button(
                            value="y+", label="y+")
                        btn_angular_z = gr.Button(
                            value="z+", label="z+")

                btn2 = gr.ClearButton(value="calibrate", label="calibrate")
                msg1 = gr.Textbox(lines=1, label="now joint")
            ...
            btn_linear_x.click(
                fn=self.count_walk(0),
                outputs=[sp])

            btn_linear_y.click(
                fn=self.count_walk(1),
                outputs=[msg1])
            btn_linear_z.click(
                fn=self.count_walk(2),
                outputs=[msg1])

            btn_angular_x.click(
                fn=self.count_walk(3),
                outputs=[msg1])

            btn_angular_y.click(
                fn=self.count_walk(4),
                outputs=[msg1])

            btn_angular_z.click(
                fn=self.count_walk(5),
                outputs=[msg1])
