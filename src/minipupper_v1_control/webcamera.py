...
class ImagePublisher(Node):
    def __init__(self):
        ...
        # self.rgb8pub = self.create_publisher(Image, 'mini_pupper_lcd/image_raw', 10)
        
        
        # self.bgr8pub = self.create_publisher(Image,'mini_pupper_lcd/image_raw', 10)
        
        
        self.mono8pub = self.create_publisher(Image, 'mini_pupper_lcd/image_raw', 10)
